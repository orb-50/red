...
<ul class="pagination" role="navigation">
    ...
    {{-- 現在ページが表示するリンクの中心位置よりも左の時 --}}
        ...
        @elseif ($paginator->currentPage() > 15 - floor(config('const.PAGINATE.LINK_NUM') / 2))
            <?php $start_page = 15 - (config('const.PAGINATE.LINK_NUM') - 1); ?>
            <?php $end_page = 15; ?>
        ...
        {{-- 定数よりもページ数が少ない時 11,12,13,14の挙動を考える --}}
    @elseif($paginator->lastPage()<=config('const.PAGINATE.LINK_NUM'))
        <?php $start_page = 1; ?>
